...
export async function generateMetadata({ params }) {
  ...
  if (!event) return buildMetadata({ title: 'Événement — Mila Events', url: `/mila-events/event/${eventId}` });
...
export default async function Page({ params }) {
  ...
  if (event) {
    ...
    schemas.push({
      ...
      url:          `${SITE_URL}/mila-events/event/${eventId}`,
      image:        images,
    ...
    schemas.push({
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name, item: `${SITE_URL}/mila-events/event/${eventId}` },
      ],
    });
  }
