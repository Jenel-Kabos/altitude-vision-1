...
import EditorialRealisations from '../components/public/EditorialRealisations';
import AltitudeTrust from '../components/public/AltitudeTrust';
import CommercialFinalCta from '../components/public/CommercialFinalCta';
...
const HomePage = () => {
  return (
    <div className="hp-root" data-testid="commercial-homepage">
