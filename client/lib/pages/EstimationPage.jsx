...
import PublicEstimationWizard from "../components/public-estimation/PublicEstimationWizard";

const GOLD = "#C8960C";
const DARK = "#0A0805"; // == rgba(10,8,5,x) utilisé dans l'overlay du hero — cohérent sur toute la page

const STATS = [
  { icon: Clock, chiffre: "Suivi", label: "Analyse par notre équipe" },
...
const PERKS = [
  {
    icon: Search,
    titre: "Analyse précise",
    desc: "Étude comparative des biens similaires dans votre quartier",
  },
  {
    icon: Zap,
    titre: "Parcours guidé",
    desc: "Un dossier structuré pour faciliter l’analyse par notre équipe",
  },
  {
    icon: Handshake,
    titre: "Expertise locale",
    desc: "5 ans d'expérience sur le marché congolais",
  },
];
...
const PAGE_CSS = `
  ...
  .ep-form-wrap { max-width: 960px; margin: 0 auto; }
...
const EstimationPage = () => {
  const carouselIndex = useAutoCarousel(
        ...
        <div className="ep-hero-content">
          <FadeIn>
            ...
            <p className="ep-subtitle">
              Préparez votre demande pas à pas afin que notre équipe puisse
              analyser votre bien.
            </p>
          </FadeIn>
        </div>
          ...
          <FadeIn delay={0.1}>
            <div className="ep-carousel-viewport">
              <div
                ...
                style={{
                  transform: `translateX(-${carouselIndex * (CAROUSEL_CARD_W + CAROUSEL_GAP)}px)`,
                }}
              >
        ...
        <div className="ep-container">
          <FadeIn>
            ...
            <p className="ep-form-subtitle">
              Un assistant guidé enregistre votre brouillon sur cet appareil.
            </p>
          </FadeIn>
          <FadeIn delay={0.1}>
            <div className="ep-form-wrap">
              <PublicEstimationWizard />
            </div>
          </FadeIn>
        </div>
      </section>
