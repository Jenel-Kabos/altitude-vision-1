        ...
        >
            ...
            <div className="hidden lg:flex flex-col justify-center px-14 xl:px-20 lg:w-[46%] flex-shrink-0">
                ...
                <h1 className="text-white text-4xl xl:text-5xl font-bold mb-5 leading-tight"
                    ...
                    Rejoignez la<br/>communauté<br/>Altimmo
                </h1>
                <p className="text-white/95 text-base mb-10 leading-relaxed max-w-sm">
                    Publiez vos biens, trouvez des locataires sérieux
                    et gérez vos annonces en toute simplicité.
                </p>
                <div className="space-y-4">
                    {['Inscription gratuite et rapide', 'Publiez jusqu’à 10 annonces', 'Accès aux outils de gestion locative'].map(item => (
            ...
            <div className="px-8 pt-8 pb-6 text-center border-b border-gray-100">
                ...
                <p className="text-sm text-gray-600">Rejoignez la plateforme en quelques clics.</p>
            </div>
            ...
            <div className="px-8 py-7">
                ...
                <div className="relative mb-4">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="px-3 text-gray-600 bg-white">ou avec un email</span>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Nom */}
                    <div>
                        <label className="block text-[0.72rem] font-bold uppercase tracking-wider text-gray-700 mb-1.5">Nom complet</label>
                    ...
                    {/* Email */}
                    <div>
                        <label className="block text-[0.72rem] font-bold uppercase tracking-wider text-gray-700 mb-1.5">Adresse email</label>
                        <div className="relative">
                    ...
                    {/* Mot de passe */}
                    <div>
                        <label className="block text-[0.72rem] font-bold uppercase tracking-wider text-gray-700 mb-1.5">Mot de passe</label>
                        <div className="relative">
                    ...
                    {/* Confirmation */}
                    <div>
                        <label className="block text-[0.72rem] font-bold uppercase tracking-wider text-gray-700 mb-1.5">Confirmer le mot de passe</label>
                        <div className="relative">
                            <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                    ...
                    {/* Rôle */}
                    <div>
                        <label className="block text-[0.72rem] font-bold uppercase tracking-wider text-gray-700 mb-1.5">Je m'inscris en tant que</label>
                        <div className="relative">
                        ...
                        <motion.div
                            ...
                            <div className="rounded-2xl border overflow-hidden"
                                ...
                                <div className="p-5 space-y-3 bg-white">
                                    ...
                                    <p className="text-xs text-gray-600 pt-1">* Tous les champs sont obligatoires. Les cases se déverrouillent après lecture complète du contrat.</p>
                                </div>
                            </div>
                        </motion.div>
                    )}
                ...
                <p className="text-center text-sm text-gray-700 pt-5 mt-1 border-t border-gray-100">
                    Déjà un compte ?{' '}
                    <Link href="/login" className="font-semibold hover:opacity-80 transition-opacity" style={{ color: BLUE_DARK }}>
                        Connectez-vous
                    </Link>
                </p>
                </div>
