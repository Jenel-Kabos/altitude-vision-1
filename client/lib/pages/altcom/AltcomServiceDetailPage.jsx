          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => router.push(`/altcom?openQuoteModal=true&service=${encodeURIComponent(service.title)}`)}
            ...
            {Object.entries(service.pricing).map(([key, plan]) => (
              ...
              >
                ...
                <button
                  onClick={() => {
                    setSelectedPlan(key);
                    router.push(`/altcom?openQuoteModal=true&service=${encodeURIComponent(`${service.title} - ${plan.name}`)}`);
                  }}
