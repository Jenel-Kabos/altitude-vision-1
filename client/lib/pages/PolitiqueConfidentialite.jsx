      ...
      <div className="space-y-4 text-gray-600">
        ...
        <div className="space-y-3">
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
            ...
            <p className="text-sm mt-1">Cloudinary (stockage images), Render (hébergement serveur), Vercel (hébergement site), MongoDB Atlas (base de données) — uniquement dans le cadre de la fourniture du service.</p>
          </div>
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
      ...
      <div className="space-y-3 text-gray-600">
        <div className="bg-slate-50 p-5 rounded-xl border border-gray-200 space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-gray-500">vercel.com</span>
          </div>
          <div className="flex items-center justify-between text-sm">
