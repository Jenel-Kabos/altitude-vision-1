...
const slides = [
  {
    title:    "Votre maison\nà Brazzaville",
    subtitle: "200+ familles logées. Biens vérifiés, conseils d'experts — trouvez, achetez ou investissez en toute confiance.",
    image:    "https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=1600&q=80",
    imgWidth: 1600,
    imgHeight:1067,
    cta:      { label: "Voir les annonces", route: "/altimmo/annonces" },
    accent:   "#2E7BB5",
    pole:     "Altimmo",
  },
  {
    title:    "L'événement\ndont vous rêvez",
    subtitle: "Mariage, gala ou conférence — Mila Events gère chaque détail pour que vous profitiez pleinement du moment.",
    image:    "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?q=80&w=1170&auto=format&fit=crop",
    imgWidth: 1170,
    imgHeight:780,
    cta:      { label: "Demander un devis", route: "/mila-events" },
    accent:   "#D42B2B",
    pole:     "Mila Events",
  },
  {
    title:    "Plus de clients\npour votre business",
    subtitle: "80+ entreprises au Congo nous font confiance. Branding, digital, stratégie — une seule agence pour tout.",
    image:    "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=1170&auto=format&fit=crop",
    imgWidth: 1170,
    imgHeight:780,
    cta:      { label: "Lancer un projet", route: "/altcom" },
    accent:   "#C8872A",
    pole:     "Altcom",
  },
];
