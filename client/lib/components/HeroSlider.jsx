...
const slides = [
  ...
  {
    title:    "Le meilleur événement\nde Brazzaville, c'est le vôtre",
    subtitle: "Du premier appel au dernier applaudissement — nous gérons chaque détail pour vous.",
  ...
  {
    title:    "80 entreprises congolaises\nont décollé avec nous",
    subtitle: "Branding, digital, stratégie — une seule agence pour construire votre image et multiplier vos clients.",
