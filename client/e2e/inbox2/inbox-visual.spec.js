...
import { FIXTURE_MESSAGES } from './fixtures.js';
...
test.beforeAll(async () => {
  ...
  const messageServiceStub = `
    ...
    export const getReceivedMessages = async () => MESSAGES;
    ...
    export const countUnread = async () => MESSAGES.filter(m => !m.isRead).length;
