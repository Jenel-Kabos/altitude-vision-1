...
const slides = [
    {
        ...
        accent:      '#D42B2B',
        accentLight: '#F08080',
        grad1:       'linear-gradient(108deg, rgba(80,10,20,0.88) 0%, rgba(10,5,8,0.55) 50%, rgba(10,5,8,0.1) 100%)',
        grad2:       'linear-gradient(to top, rgba(10,5,8,0.82) 0%, transparent 55%)',
    },
    {
        ...
        accent:      '#A01E1E',
        accentLight: '#D88080',
        grad1:       'linear-gradient(108deg, rgba(20,5,5,0.9) 0%, rgba(10,5,8,0.52) 50%, rgba(10,5,8,0.08) 100%)',
        grad2:       'linear-gradient(to top, rgba(10,5,8,0.85) 0%, transparent 55%)',
    },
    {
        ...
        accent:      '#C8872A',
        accentLight: '#E8B86D',
        grad1:       'linear-gradient(108deg, rgba(30,15,0,0.88) 0%, rgba(10,5,0,0.55) 50%, rgba(10,5,0,0.08) 100%)',
        grad2:       'linear-gradient(to top, rgba(10,5,0,0.82) 0%, transparent 55%)',
    },
];
...
const HeroSliderMila = () => {
    ...
    return (
        <div className="absolute inset-0 overflow-hidden" role="region" aria-label="Diaporama Mila Events" aria-roledescription="carousel">
                    ...
                    <div key={"text-" + idx} style={{ maxWidth: '560px' }}>
                        ...
                        <motion.div variants={stagger(0.1)} initial="hidden" animate="visible" exit="exit"
                            ...
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '9px',
                                ...
                                border: "1px solid " + s.accent + "45", background: s.accent + "15", backdropFilter: 'blur(10px)' }}>
                                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: s.accent,
                                    boxShadow: "0 0 8px " + s.accent, animation: 'milaPulse 2.2s ease-in-out infinite' }} />
                                <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 'clamp(0.58rem,1.1vw,0.66rem)',
                                    fontWeight: 500, letterSpacing: '0.22em', textTransform: 'uppercase', color: s.accentLight }}>
                                    {s.eyebrow}
                                </span>
                            </span>
                        </motion.div>
                        ...
                        <motion.h1 variants={stagger(0.2)} initial="hidden" animate="visible" exit="exit"
                            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif",
                                ...
                                letterSpacing: '-0.025em', color: '#FDF8F5',
                        ...
                        <motion.p variants={stagger(0.35)} initial="hidden" animate="visible" exit="exit"
                            style={{ fontFamily: "'Outfit', sans-serif", fontSize: 'clamp(0.84rem,1.5vw,1rem)',
                                fontWeight: 300, lineHeight: 1.78, color: 'rgba(253,248,245,0.62)',
                        ...
                        <motion.blockquote variants={stagger(0.45)} initial="hidden" animate="visible" exit="exit"
                            ...
                            <span style={{ fontFamily: "'Cormorant Garamond', serif",
                                ...
                                fontWeight: 400, color: 'rgba(253,248,245,0.5)', lineHeight: 1.6 }}>
                                {s.quote}
                            </span>
                        </motion.blockquote>
                        ...
                        <motion.div variants={stagger(0.52)} initial="hidden" animate="visible" exit="exit"
                            ...
                            <Link to={s.cta.to}
                                style={{ display: 'inline-flex', alignItems: 'center', gap: '9px',
                                    ...
                                    fontSize: 'clamp(0.7rem,1.3vw,0.8rem)', fontWeight: 500,
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                <div style={{ width: '1px', height: '34px', background: 'rgba(253,248,245,0.1)' }} />
                                <div>
                                    ...
                                    <p style={{ fontFamily: "'Outfit', sans-serif",
                                        ...
                                        letterSpacing: '0.1em', color: 'rgba(253,248,245,0.35)',
              ...
              { fn: next, side: 'right', Icon: ChevronRight, label: 'Image suivante' }].map(({ fn, side, Icon, label }) => (
                <button key={side} onClick={fn} aria-label={label}
                    style={{ position: 'absolute', [side]: 'clamp(12px,2.5vw,24px)', top: '50%',
                        ...
                        borderRadius: '50%', background: 'rgba(253,248,245,0.07)',
                        backdropFilter: 'blur(12px)', border: '1px solid rgba(253,248,245,0.1)',
                        color: 'rgba(253,248,245,0.6)', display: 'flex', alignItems: 'center',
                        justifyContent: 'center', cursor: 'pointer', transition: '0.2s' }}
                    onMouseEnter={e => { e.currentTarget.style.background = s.accent + "28"; e.currentTarget.style.borderColor = s.accent + "50"; e.currentTarget.style.color = '#fff'; }}
                    onMouseLeave={e => { e.currentTarget.style.background = 'rgba(253,248,245,0.07)'; e.currentTarget.style.borderColor = 'rgba(253,248,245,0.1)'; e.currentTarget.style.color = 'rgba(253,248,245,0.6)'; }}>
            ...
            <div style={{ position: 'absolute', bottom: '28px', right: '20px', zIndex: 20,
                ...
                <div style={{ width: '1px', height: '52px', background: 'rgba(253,248,245,0.1)', overflow: 'hidden' }}
                    ...
                    {slides.map((sl, i) => (
                        <button key={i} onClick={() => goTo(i)} role="tab" aria-selected={i === idx}
                            ...
                            <span style={{ display: 'block', width: i === idx ? '18px' : '5px', height: '4px',
                                borderRadius: '2px', background: i === idx ? s.accent : 'rgba(253,248,245,0.22)',
                                boxShadow: i === idx ? "0 0 6px " + s.accent + "90" : 'none', transition: 'all 0.4s ease' }} />
                        </button>
                    ))}
                </div>
                <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.6rem', letterSpacing: '0.18em',
                    color: 'rgba(253,248,245,0.28)', userSelect: 'none' }} aria-hidden="true">
