...
const PropertyCard = ({ property, index = 0, viewMode = 'grid' }) => {
  ...
  if (viewMode === 'list') {
    return (
      ...
      >
        <Link to={`/altimmo/property/${property._id}`} className="pcard-list-inner">
  ...
  return (
    ...
    >
      <Link to={`/altimmo/property/${property._id}`} className="pcard-link" style={{ display:'flex', flexDirection:'column', height:'100%' }}>
