...
// ─────────────────────────────────────────────────────────────
// EventCard — ✅ pas de SEOHead ici, c'est un sous-composant
// ─────────────────────────────────────────────────────────────
const EventCard = ({ event, index }) => {
    ...
    return (
        ...
        >
            <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute top-3 left-3 right-3 flex justify-between items-start">
                    <span className="text-white text-xs font-bold px-3 py-1 rounded-full"
                        style={{ background: 'rgba(212,43,43,0.85)', backdropFilter: 'blur(8px)' }}>
                        {d.category}
                    </span>
                    {d.videos?.length > 0 && (
            ...
            <div className="p-5">
                <h3 className="font-bold text-gray-900 text-lg mb-1.5 line-clamp-1 group-hover:text-[#D42B2B] transition-colors"
                ...
                <div className="space-y-1.5 text-xs text-gray-400 mb-4">
                    <div className="flex items-center gap-2">
                        <Calendar className="w-3.5 h-3.5 flex-shrink-0" style={{ color: '#D42B2B' }} />
                        {formattedDate}
                    </div>
                    <div className="flex items-center gap-2">
                        <MapPin className="w-3.5 h-3.5 flex-shrink-0" style={{ color: '#D42B2B' }} />
                        <span className="line-clamp-1">{d.location}</span>
                    </div>
                </div>
                <div className="pt-4 border-t border-gray-100">
                    <span className="inline-flex items-center gap-1.5 text-sm font-semibold"
                        style={{ color: '#D42B2B', fontFamily: "'Outfit', sans-serif" }}>
                        Voir les détails
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
                ...
                <div className="sticky top-0 bg-white z-10 px-7 pt-7 pb-5 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl flex items-center justify-center"
                            style={{ background: 'linear-gradient(135deg, #D42B2B, #A01E1E)' }}>
                ...
                <form onSubmit={handleSubmit} className="px-7 py-6 space-y-4">
                    <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl"
                        style={{ backgroundColor: 'rgba(212,43,43,0.06)', border: '1px solid rgba(212,43,43,0.15)' }}>
                        <Sparkles className="w-4 h-4" style={{ color: '#D42B2B' }} />
                        <span className="text-sm font-semibold" style={{ color: '#D42B2B', fontFamily: "'Outfit', sans-serif" }}>
                            {formData.service}
                        </span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea value={formData.description} onChange={set('description')} required rows={4}
                            ...
                            className={cls + " resize-none"} style={{ fontFamily: "'Outfit', sans-serif" }} />
                    ...
                    <motion.button type="submit" disabled={isSubmitting}
                        ...
                        style={{
                            background:  isSubmitting ? '#9CA3AF' : 'linear-gradient(135deg, #D42B2B, #A01E1E)',
                            boxShadow:   isSubmitting ? 'none' : '0 4px 20px rgba(212,43,43,0.35)',
                            fontFamily:  "'Outfit', sans-serif",
                        }}>
                        {isSubmitting
...
const MilaEventsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
            ...
            {/* ══ SEO ══════════════════════════════════════════════════
                ✅ Placé à l'intérieur du composant MilaEventsPage,
                   pas en dehors ni dans un sous-composant comme EventCard.
                   title/description optimisés avec mots-clés locaux Congo.
            ════════════════════════════════════════════════════════ */}
            <SEOHead
                ...
                url="/mila-events"
                image="/og-mila-events.jpg"
                type="website"
                breadcrumb={[
                    { name: 'Accueil',     path: '/' },
                    { name: 'Mila Events', path: '/mila-events' },
                ]}
            />
                ...
                <div className="absolute inset-0 z-10 flex flex-col justify-center px-4 sm:px-8 lg:px-16">
                    <div className="max-w-6xl mx-auto w-full">
                        ...
                        <motion.div initial={{ width: 0 }} animate={{ width: '64px' }} transition={{ delay: 0.4, duration: 0.6 }}
                            ...
                            style={{ background: 'linear-gradient(to right, #D42B2B, #C8872A)' }} />
                        <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.3, duration: 0.7 }}
                            className="text-white/75 max-w-xl mb-8 leading-relaxed font-light"
                    ...
                    <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <h2 className="text-gray-900 mb-5"
                                ...
                                Chaque Événement,
                                <span className="block" style={{ color: '#D42B2B' }}>Une Signature</span>
                            </h2>
                            ...
                            <ul className="space-y-3 mb-8">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-sm text-gray-600">
                                        <CheckCircle className="w-4 h-4 flex-shrink-0" style={{ color: '#D42B2B' }} />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
                            ...
                            {[
                                { value: '50+',  label: 'Événements organisés', color: '#D42B2B' },
                                { value: '98%',  label: 'Clients satisfaits',   color: '#A01E1E' },
                                { value: '5 ans',label: "D'expérience",          color: '#D42B2B' },
                                { value: '24h',  label: 'Délai de réponse',      color: '#C8872A' },
                ...
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                        {EVENT_TYPES.map(type => (
                            <button key={type} onClick={() => { setFilterType(type); setCurrentPage(1); }}
                                ...
                                style={{
                                    background:   filterType === type ? 'linear-gradient(135deg, #D42B2B, #A01E1E)' : 'white',
                                    color:        filterType === type ? 'white' : '#D42B2B',
                                    borderColor:  filterType === type ? 'transparent' : 'rgba(212,43,43,0.25)',
                                    boxShadow:    filterType === type ? '0 4px 12px rgba(212,43,43,0.3)' : 'none',
                                    fontFamily:   "'Outfit', sans-serif",
                                }}>
                                {type}
                            </button>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16 rounded-3xl border border-dashed"
                            style={{ borderColor: 'rgba(212,43,43,0.25)', backgroundColor: 'rgba(212,43,43,0.03)' }}>
                ...
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    ...
                    {reviewsLoading ? (
                        ...
                        <div className="text-center py-14 rounded-3xl border border-dashed"
                            style={{ borderColor: 'rgba(212,43,43,0.2)', backgroundColor: 'rgba(212,43,43,0.03)' }}>
