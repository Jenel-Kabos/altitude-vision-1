    ...
    return (
        <div className="min-h-screen bg-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
            ...
            <header className="relative text-white overflow-hidden"
                ...
                {/* ── CTAs flottants ───────────────────────────────────
                    Palette rouge Mila : bouton principal rouge sang,
                    bouton secondaire verre sombre à bordure rouge douce.
                ──────────────────────────────────────────────────── */}
                <motion.div
                ...
                >
                    ...
                    <button
                        onClick={() => openQuote('Demande Générale')}
                        style={{
                            ...
                            boxShadow: `0 6px 24px ${RED}52`,
                            transition: 'transform 0.2s, box-shadow 0.2s',
                            whiteSpace: 'nowrap',
                        }}
                        onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = `0 10px 32px ${RED}70`; }}
                        onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = `0 6px 24px ${RED}52`; }}
                        aria-label="Demander un devis Mila Events"
                    >
                    ...
                    <Link
                        ...
                        onMouseEnter={e => { e.currentTarget.style.background = `${RED}1A`; e.currentTarget.style.borderColor = `${RED}65`; }}
                        onMouseLeave={e => { e.currentTarget.style.background = 'rgba(10,4,4,0.45)'; e.currentTarget.style.borderColor = `${RED}40`; }}
                    >
