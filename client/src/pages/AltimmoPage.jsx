...
// ─────────────────────────────────────────────────────────────
// Données statiques — valeurs alignées sur le modèle Property
// ─────────────────────────────────────────────────────────────
const SERVICES = [
    {
        icon:  Key,
    ...
    },
    {
        ...
        desc:  'Bénéficiez de notre expertise du marché local pour réaliser des investissements immobiliers judicieux.',
...
// ✅ Valeurs exactes du modèle : status enum ['vente', 'location']
...
// Budgets en FCFA — valeurs numériques transmises en query params
const BUDGETS = [
...
const AltimmoPage = () => {
    ...
    // ✅ État barre de recherche — valeurs cohérentes avec le modèle
    const [typeBien,     setTypeBien]    = useState('Tous');
    const [transaction,  setTransaction] = useState('vente');   // valeur BDD
    const [budgetIdx,    setBudgetIdx]   = useState(0);          // index dans BUDGETS

    const handleSearch = () => {
        const params = new URLSearchParams();
        // ✅ 'status' correspond au champ BDD (enum: 'vente' | 'location')
        ...
        <div className="min-h-screen bg-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    ...
                    <div className="max-w-6xl mx-auto w-full">
                        ...
                        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                {/* ✅ Transaction — valeurs 'vente' | 'location' (enum BDD) */}
                                ...
                                {/* ✅ Budget — index dans BUDGETS pour transmettre min/max numériques */}
                                <div className="relative flex-1">
                                    <label className="absolute -top-2 left-3 text-[10px] font-bold uppercase tracking-wider text-white/60 px-1">
                                        Budget
                                    </label>
                                    <div className="relative">
                                        <select value={budgetIdx} onChange={e => setBudgetIdx(Number(e.target.value))}
                                            ...
                                            style={{ fontFamily: "'Outfit', sans-serif" }}>
                                            {BUDGETS.map((b, i) => (
                                                <option key={i} value={i} className="text-gray-900">{b.label}</option>
                                            ))}
                                        </select>
                                        <ChevronDown className="absolute right-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/50 pointer-events-none" />
                                    </div>
                                ...
                                <button onClick={handleSearch}
                                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-white text-sm transition-all hover:scale-105 flex-shrink-0"
                                    style={{
                        ...
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                            transition={{ delay: 0.7 }} className="mt-5 flex flex-wrap gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <p className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: '#2E7BB5' }}>
                                Notre approche
                            </p>
                            ...
                            <Link to="/altimmo/annonces"
                                ...
                                style={{ background: 'linear-gradient(135deg, #2E7BB5, #1A5A8A)', boxShadow: '0 4px 20px rgba(46,123,181,0.3)', fontFamily: "'Outfit', sans-serif" }}>
                                Découvrir nos biens
            ...
            <section className="py-16 sm:py-20 bg-gray-50">
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                        ...
                        <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#2E7BB5' }}>Nos Engagements</p>
                        ...
                        <p className="text-gray-500 text-sm max-w-xl mx-auto">Chaque service est conçu pour maximiser votre rendement</p>
                    </motion.div>
                ...
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#2E7BB5' }}>Notre Sélection</p>
                        ...
                        <Link to="/altimmo/annonces" className="inline-flex items-center gap-2 text-sm font-semibold group flex-shrink-0" style={{ color: '#2E7BB5' }}>
            ...
            <section className="py-16 sm:py-20 relative overflow-hidden"
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-1/4 w-80 h-80 rounded-full blur-[120px] opacity-10" style={{ background: '#2E7BB5' }} />
                ...
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#C8872A' }}>Estimation gratuite</p>
                            ...
                            <p className="text-white/60 leading-relaxed mb-6 text-sm">
                                Obtenez une estimation professionnelle et gratuite de votre propriété en moins de 24h.
                            </p>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <div className="space-y-3">
                                ...
                                <motion.a href="#contact-altimmo" onClick={handleScrollToContact}
                                    whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                                    className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-white text-sm mt-2"
                                    style={{ background: 'linear-gradient(135deg, #C8872A, #E5A84B)', boxShadow: '0 4px 20px rgba(200,135,42,0.3)', fontFamily: "'Outfit', sans-serif" }}>
                                    <Calculator className="w-4 h-4" /> Demander mon estimation
                                </motion.a>
                                <p className="text-center text-white/30 text-xs mt-2">Gratuit · Sans engagement · Sous 24h</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-16 sm:py-20 bg-gray-50">
                <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#2E7BB5' }}>Témoignages</p>
                            <h2 className="text-gray-900" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', fontWeight: 700, lineHeight: 1.1 }}>
                        ...
                        <motion.button onClick={handleLeaveReview} whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
                            ...
                            style={{ background: 'linear-gradient(135deg, #2E7BB5, #1A5A8A)', boxShadow: '0 4px 16px rgba(46,123,181,0.3)', fontFamily: "'Outfit', sans-serif" }}>
