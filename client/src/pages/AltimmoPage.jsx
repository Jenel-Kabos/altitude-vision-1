...
const PAGE_CSS = `
  ...
  .ai-panel-search-btn {
    ...
    padding: 10px; border-radius: 8px; font-family: 'Outfit', sans-serif;
  ...
  /* ══ À PROPOS ══ */
  .ai-about-section { padding: var(--py) 0; background: #fff; overflow: hidden; }
  .ai-about-grid {
    display: grid; grid-template-columns: 1fr;
  ...
  .ai-about-body {
    font-size: clamp(0.90rem, 2vw, 1rem); color: #4B5563; line-height: 1.75; margin-bottom: 18px;
  }
  .ai-about-check {
    display: flex; align-items: center; gap: 10px;
    font-size: clamp(0.84rem, 2vw, 0.86rem); color: #4B5563;
  }

  .ai-stats-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; }
  .ai-stat-card {
    padding: clamp(18px, 3.5vw, 26px); border-radius: 18px;
  ...
  /* ══ SERVICES ══ */
  .ai-services-section { padding: var(--py) 0; background: #F9FAFB; }
  .ai-services-grid {
  ...
  .ai-service-card {
    ...
    border: 1px solid; position: relative; overflow: hidden; transition: all 0.4s ease;
  }
  .ai-service-card:hover { transform: translateY(-5px); box-shadow: 0 16px 48px rgba(0,0,0,0.07); }
  ...
  .ai-service-title {
    font-size: clamp(0.98rem, 2.5vw, 1.05rem); font-weight: 700; color: #111827; margin-bottom: 7px;
  }
  .ai-service-desc {
  ...
  .ai-service-cta {
    ...
    font-size: 0.72rem; font-weight: 600; transition: gap 0.2s;
  }

  /* ══ BIENS ══ */
  .ai-properties-section { padding: var(--py) 0; background: #fff; }
  .ai-properties-head {
  ...
  .ai-skeleton-card { border-radius: 20px; overflow: hidden; border: 1px solid #F3F4F6; background: #fff; animation: aiSkeleton 2s ease-in-out infinite; }
  .ai-skeleton-img  { height: 210px; background: #E5E7EB; }
  .ai-skeleton-body { padding: 18px; display: flex; flex-direction: column; gap: 9px; }
  .ai-skeleton-line { height: 12px; border-radius: 5px; background: #F3F4F6; }
  ...
  .ai-estimation-body {
    font-size: clamp(0.84rem, 1.8vw, 0.86rem); color: rgba(255,255,255,0.56); line-height: 1.75; margin-bottom: 22px;
  }
  .ai-estimation-check {
    display: flex; align-items: center; gap: 9px;
    font-size: clamp(0.82rem, 1.8vw, 0.83rem); color: rgba(255,255,255,0.56);
  }

  /* ══ AVIS ══ */
  .ai-reviews-section { padding: var(--py) 0; background: #F9FAFB; }
  .ai-reviews-head {
    display: flex; flex-direction: column; gap: 14px;
    ...
    return (
        <div className="ai-page" style={{ minHeight:'100vh', background:'#fff' }}>
            ...
            <SEOHead
                ...
                url="/altimmo" image="/og-altimmo.jpg"
                            ...
                            return (
                                <FadeIn key={i} delay={i*0.09} y={28}>
                                    <div className="ai-service-card" style={{ borderColor:`${service.color}18` }}>
                                        ...
                                        <Link to={`/altimmo/services/${service.slug}`} className="ai-service-cta" style={{ color:service.color }}>
                ...
                <div className="ai-container">
                    ...
                    {loading ? (
                        ...
                        <div style={{ textAlign:'center', padding:'clamp(36px,7vw,72px) 20px', borderRadius:'20px', border:`1px dashed ${BLUE}28`, background:`${BLUE}03` }}>
                            ...
                            <p style={{ fontWeight:700, color:'#374151', marginBottom:'5px', fontSize:'clamp(0.90rem,2vw,0.95rem)' }}>Aucune annonce disponible</p>
                ...
                <div className="ai-container">
                    ...
                    {reviewsLoading ? (
                        <div className="ai-reviews-grid">
                            {[1,2,3].map(i=>(
                                <div key={i} style={{ background:'#fff', borderRadius:'20px', padding:'20px', border:'1px solid #F3F4F6', animation:'aiSkeleton 2s ease-in-out infinite' }}>
                        ...
                        <div style={{ textAlign:'center', padding:'clamp(36px,7vw,64px) 20px', borderRadius:'20px', border:`1px dashed ${BLUE}22`, background:`${BLUE}02` }}>
                            <Star size={24} style={{ color:'#D1D5DB', margin:'0 auto 10px', display:'block' }} />
                            <p style={{ fontWeight:700, color:'#374151', marginBottom:'5px', fontSize:'clamp(0.90rem,2vw,0.95rem)' }}>Aucun avis pour le moment</p>
            ...
            {/* ══ CTA ═════════════════════════════════════════════════ */}
            <section style={{ padding:'clamp(36px,7vw,52px) 0', background:'#fff' }}>
