...
// ── Scène SVG originale (conservée comme fallback) ────────────────────────────
function Scene() {
  return (
...
// ── Composant principal ───────────────────────────────────────────────────────
// imageUri : URL réseau de la photo (Unsplash, etc.)
//            Si absent → scène SVG originale (fallback)
export default function ImmobilierHero({ title, subtitle, imageUri }) {
  if (imageUri) {
    return (
      <ImageBackground
        source={{ uri: imageUri }}
      ...
      >
        {/* Gradient du bas : assombrit pour rendre le texte lisible */}
        <LinearGradient
