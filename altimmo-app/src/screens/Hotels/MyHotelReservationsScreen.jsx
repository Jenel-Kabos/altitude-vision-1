...
export default function MyHotelReservationsScreen({ navigation }) {
  ...
  return <SafeAreaView style={styles.safe} edges={['top']}><PageHeader title="Mes réservations hôtel" onBack={() => navigation.goBack()} />
    <ScrollView contentContainerStyle={styles.content}><Button label="Réserver un hôtel" icon="add" onPress={() => navigation.navigate('HotelBooking')} style={styles.action} />
